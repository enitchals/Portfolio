        ...
        return(
            <div className="MH-door">
                {(this.props.revealDoor == this.props.door)
                    ? <img className="MH-doorWidth" src={goat}/>
                    : (this.props.secondPick === null)
                        ? <img className="MH-doorWidth" src={this.props.doorImg} onClick={() => this.props.firstDoorPick(this.props.door)}/>
                        : (this.props.prizeDoor == this.props.door)
                            ? <img className="MH-doorWidth" src={prize}/>
                            : <img className="MH-doorWidth" src={goat}/>
                            }
            </div>
        )
