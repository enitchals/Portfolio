...
// RESET THE SIMULATION
  ...
  render() {
    return (
      ...
      <div className="MH-Simulation column">
        {(this.state.intro)
          ? null
          : <div className="MH-door-row MH-box">
        ...
        <div className="MH-Text MH-box">
          <div className="MH-title">Monty Hall Simulator</div>
          ...
          {(this.state.firstPick !== null && this.state.secondPick === null)
            ?<button className="MH-buttons" onClick={this.stayDoor}>STAY</button>
            : ''}
          {(this.state.firstPick !== null && this.state.secondPick === null)
            ?<button className="MH-buttons" onClick={this.switchDoor}>SWAP</button>
            : ''}
          {(this.state.firstPick !== null && this.state.secondPick !== null)
            ?<button className="MH-buttons" onClick={this.reset}>TRY AGAIN</button>
            : ''}
          </div>
        </div>
      </div>
      <div className="MH-results MH-box">
        <img className="MH-goatimg" src={GOAT}/>
        <div className="MH-results-table">
          <h3>RESULTS:</h3>
          <tr>
            <th>&nbsp;</th>
            <th>stay</th>
